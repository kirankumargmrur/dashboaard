...
public class DashboardController {
    ...
    @RequestMapping(value = "/dashboard/collectorItemId/{id}", method = GET, produces = APPLICATION_JSON_VALUE)
    public DataResponse<Iterable<CIData>> fetchCIData(@PathVariable ObjectId id) {
    	LOGGER.info("RetrieveCIData: " + id);
    	DataResponse<Iterable<CIData>> dataresponse =  dashboardService.retrieveCIData(id);
        return dataresponse;
    }

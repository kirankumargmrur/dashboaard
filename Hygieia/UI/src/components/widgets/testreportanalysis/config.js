...
(function () {
    ...
    angular
        ...
        .controller('TestReportAnalysisConfigController', TestReportAnalysisConfigController);

    TestReportAnalysisConfigController.$inject = ['modalData', '$scope', 'collectorData', '$uibModalInstance'];
    function TestReportAnalysisConfigController(modalData, $scope, collectorData, $uibModalInstance) {
        var ctrl = this,

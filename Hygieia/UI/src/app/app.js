        ...
        .config(function ($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider
                ...
                .state('dashboardState', {
                    url: '/dashboard/:id?delete&reset?version',
                    controller: 'DashboardController as ctrl',
                    templateUrl: 'app/dashboard/views/dashboard.html',
                    resolve: {
                        dashboard: function ($stateParams, dashboardData, versionFilter) {
                           versionFilter.setVersionFilterData($stateParams.version);
                           return dashboardData.getVersionFilter($stateParams.id, $stateParams.version);
                        }
                    }
                })
                ...
                .state('collectorItem', {
                    url: '/collectorItem/:dashboardId/:collectorId',
                    controller: 'PipelineOverviewController as ctrl',

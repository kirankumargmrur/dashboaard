...
(function () {
    ...
    function dashboardData($http) {
        ...
        var pipeLineOverview = '/api/dashboard/collectorItemId';
        return {
            search: search,
            ...
            getPipeLineOverview: getPipeLineOverview
        };
        ...
        function getVersionFilter(id, version){
           return detail(id).then(function (response) {
             tempDashBoardData = response; 
             if( typeof version != 'undefined' && version != null ){
                 tempDashBoardData.versionFilter = version;
             }
             else{
                 tempDashBoardData.versionFilter = -1;
             }
             return tempDashBoardData;
           });
        }
        ...
        function getPipeLineOverview(collectorItemId){
            return getPromise(HygieiaConfig.local ? testDetailRoute : pipeLineOverview + '/' + collectorItemId);
        }

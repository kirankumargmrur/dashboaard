    ...
    function paginationWrapperService ($q, DashboardType, dashboardData, dashboardService, userService) {
        ...
        this.processDashboardResponse = function (response) {
            ...
            for (var x = 0; x < data.length; x++) {
                ...
                if(data[x].application.components[0].collectorItems.Build){
                    board.collectorItemId = data[x].application.components[0].collectorItems.Build[0].id;
                }
        ...
        this.processMyDashboardResponse = function (response) {
            ...
            for (var x = 0; x < mydata.length; x++) {
                ...
                var board = {
                    ...
                    //collectorItemId : mydata[x].application.components[0].collectorItems.Build[0].id
                };

                if(mydata[x].application.components[0].collectorItems.Build){
                    board.collectorItemId = mydata[x].application.components[0].collectorItems.Build[0].id;
                }
